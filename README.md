...
Forniremo i contatti e-mail agli studenti
...
- ## **Intelligenza Artificiale** 
    ...
    - ### Cos'è
       ...
       Cosa si intende per _corretto_ dipende totalmente dall'ambito di applicazione, e ne vedremo vari più avanti.
        ...
        Questa classificazione teorica può essere difficile da distinguere nella pratica, ma diventa più chiara con un esempio, come il sistema di guida autonoma di un’auto di nuova generazione.
...
- ## **Sinergie dell'AI con altri trend tecnologici** 
    ...
    - ### 5G 
        - #### Cos'è? 
        - #### Come cambierà le città?
        - #### Come si integra con l'AI?
    ...
    - ### Smart Homes
        - #### Cosa sono?
        - #### Come impatteranno sulla vita quotidiana?
        - #### Il caso: Alexa (Assistente virtuale di Amazon)
        - #### Cosa sanno di te le grandi tech companies?
        
    - ### Blockchain
        - #### Cos'è?
        - #### Cosa sono le criptovalute?
        - #### Come possono trasformare l'economia?
        
            - #### Il caso: Bitcoin 
            - #### Il caso: Lybra (Facebook coin)
...
- ## **Psicologia dell'individuo**
    ...
    - ### Scelte affidate agli algoritmi
    
    - ### Distorsioni percettive (bias umani)

---

# Cosa fare per essere preparati
    
- ## **Il problema della non predicibilità**

    - ### Quale orizzonte temporale è predicibile?
    - ### Cosa _non_ cambierà nel futuro?
    - ### Il problema della convergenza
    
- ## **Apprendimento**

    - ### Università _diverso da_ Posto di lavoro
    - ### Apprendimento continuo
    - ### Soft skills 
    - ### Creatività

- ## **Comprendere cosa è automatizzabile e cosa no**

![](https://i.imgur.com/4mc1KmV.png)

# Etica e considerazioni 
    
- ## **Influenza delle tech companies**
    
    - ### Politica
    
    - ### Bolle culturali

- ## **Dipendenza dalla tecnologia, deficit cognitivi e de-personificazione**
    
    - ### Scomparsa del limite tra vita reale e virtuale
    
    - ### Influenza degli algoritmi nella cultura, nei gusti e nelle scelte personali

    - ### Effetto della tecnologia sui giovanissimi
    
    - ### Delegazione delle scelte agli algoritmi
    
    - ### Decisori autonomi e libero arbitro
    
    - ### Dissoluzione dell'Io (cosa significa essere umani, quando una macchina sceglie al posto tuo, meglio di te?)

- ## **Diseguaglianze**
    
    - ### Collettive
        - #### La corsa di USA e Cina
        - #### Paesi che rimarranno indietro
...
I temi qua elencati costituiscono un insieme molto ampio, e sicuramente va operata una "scrematura" in base a vari fattori:
    
- Quali sono i temi più importanti / urgenti?
- Cosa interessa di più ai ragazzi?
- Quali sono i corsi target?

### Tempistiche

- **Estensione del corso**

    Il numero di ore ideale per trattare una parte consistente dei temi elencati è di **ore minime: 4**

    In base al feedback degli studenti si può poi estendere il progetto con ulteriori ore:
    - 2 - Discussione [ Opzionale, ma _raccomandata_ ]
    - 2 - Laboratorio [ Opzionale ]

    In ogni caso, c'è totale flessibilità per quanto rigarda l'estensione del progetto.
    
- **Giorni della settimana**

    Da definire in base all'estensione del progetto e alla disponibilità delle ore dei professori coinvolti.


### Classi

Essendo questo progetto "sperimentale" suggerirei di iniziare con al massimo 2 classi. Sarebbe interessante avere due classi appartenenti a corsi diversi (ad esempio, una di Beni Culturali e una di Scienze Applicate).

Per ogni corso si possono diversificare leggermente i contenuti: 

- Ad esempio, per il corso BC si potrebbero inserire la presentazione di alcune applicazioni di AI legate al mondo della conservazione dell'arte e della documentazione storica.
- Viceversa, per il corso SA si potrebbe pensare a un laboratorio pratico dove i ragazzi possono approcciarsi con il Python (linguaggio di programmazione flessibile e facile da imparare, alla base delle applicazioni di AI).

Le classi adatte a questo tipo di seminario sono chiaramente quelle finali del percorso, in particolare le quinte in quanto sono prossime alla scelta dell'Università.

Anche le classi quarte probabilmente sono un ottimo target.


# Burocrazia

Attendo l'incontro a scuola per dettagliare questa sezione.

- passi da parte nostra
- passi da parte dell' istituto
